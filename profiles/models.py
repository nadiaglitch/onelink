...
username_validator = RegexValidator(
    ...
    message=(
        "Username must be 5–15 characters, using only lowercase letters, "
...
handle_validator = RegexValidator(
    regex=r"^[a-z0-9_]{5,15}$",
    message=(
        "Handle must be 5–15 characters, using only lowercase letters, "
        "numbers, or underscores."
    ),
)
    ...
    class Meta:
        ...
        constraints = [
            models.UniqueConstraint(
                ...
                name="uniq_link_position_per_profile",
            )
        ]
